...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-10 bg-gray-900 flex flex-row items-center h-16 justify-between border-b border-b-gray-600 px-3 md:px-40 xl:px-64 2xl:px-96">
      <div>
